...
def _migrate_db():
    """Ensure newly added columns and tables exist in SQLite and PostgreSQL tables."""
    # PostgreSQL / Cloud DB migration
    if not Config.SQLALCHEMY_DATABASE_URI.startswith('sqlite:///'):
        pg_statements = [
            ...
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS smtp_user VARCHAR(120);',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS smtp_password VARCHAR(120);',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_bot_token VARCHAR(255);',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_chat_id VARCHAR(100);',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_morning_reminder_enabled BOOLEAN DEFAULT TRUE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_morning_reminder_time VARCHAR(10) DEFAULT \'07:00\';',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_evening_reminder_enabled BOOLEAN DEFAULT TRUE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS telegram_evening_reminder_time VARCHAR(10) DEFAULT \'19:00\';',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS last_morning_sent_date DATE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS last_evening_sent_date DATE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS alert_on_all_users BOOLEAN DEFAULT TRUE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS cooldown_minutes INTEGER DEFAULT 30;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS max_alerts_per_day INTEGER DEFAULT 3;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS alert_on_first_login_only BOOLEAN DEFAULT FALSE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS alert_on_owner_login BOOLEAN DEFAULT FALSE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS alert_on_staff_login BOOLEAN DEFAULT TRUE;',
            'ALTER TABLE "alert_settings" ADD COLUMN IF NOT EXISTS alert_on_failed_attempts BOOLEAN DEFAULT TRUE;',
            'ALTER TABLE "job_wage_entry" ADD COLUMN IF NOT EXISTS group_id INTEGER;',
            'ALTER TABLE "job_wage_entry" ADD COLUMN IF NOT EXISTS tray_count DOUBLE PRECISION DEFAULT 0.0;',
            'ALTER TABLE "job_wage_entry" ADD COLUMN IF NOT EXISTS pieces_per_tray DOUBLE PRECISION DEFAULT 105.0;',
            'ALTER TABLE "job_wage_entry" ADD COLUMN IF NOT EXISTS wastage_per_tray DOUBLE PRECISION DEFAULT 5.0;',
            'ALTER TABLE "job_wage_entry" ADD COLUMN IF NOT EXISTS total_wastage DOUBLE PRECISION DEFAULT 0.0;',
            ...
            'ALTER TABLE "party" ADD COLUMN IF NOT EXISTS default_selling_rate DOUBLE PRECISION DEFAULT 0.0;',
            'ALTER TABLE "material_inward" ADD COLUMN IF NOT EXISTS quantity_unit VARCHAR(20) DEFAULT \'Ton\';',
            'ALTER TABLE "material_outward" ADD COLUMN IF NOT EXISTS quantity_unit VARCHAR(20) DEFAULT \'Ton\';',
            'CREATE TABLE IF NOT EXISTS "employee_group" (id SERIAL PRIMARY KEY, name VARCHAR(100) NOT NULL, description VARCHAR(255), default_job_type VARCHAR(50), default_product_name VARCHAR(100), is_active BOOLEAN DEFAULT TRUE, created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP);',
            'CREATE TABLE IF NOT EXISTS "employee_group_members" (group_id INTEGER NOT NULL REFERENCES "employee_group"(id) ON DELETE CASCADE, employee_id INTEGER NOT NULL REFERENCES "employee"(id) ON DELETE CASCADE, PRIMARY KEY (group_id, employee_id));',
        ...
        try:
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS "employee_group" (
                    ...
                    default_job_type VARCHAR(50),
                    default_product_name VARCHAR(100),
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS "employee_group_members" (
                    ...
                    FOREIGN KEY (group_id) REFERENCES employee_group(id) ON DELETE CASCADE,
            ...
            print(f"[WARN] SQLite migration notice: {e}")
